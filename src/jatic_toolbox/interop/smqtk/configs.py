from jatic_toolbox._internals.interop.smqtk.configs import create_smqtk_model_config

__all__ = ["create_smqtk_model_config"]
...
#     for k in smqtk.object_detection._MODELS.keys():
#         name = f"smqtk__centernet-{k}"

#         if name not in [m[1] for m in jatic_store["model"]]:
#             jatic_models(
#                 builds(
#                     smqtk.object_detection.CenterNetVisdrone,
#                     model=k,
