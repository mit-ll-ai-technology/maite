...
def test_component_entrypoint_static_verification():
    ...
    od_model_results: dict[str, bool] = statically_verify_component_entrypoint_against_protocol(
    ...
    ic_metric_results: dict[str, bool] = statically_verify_component_entrypoint_against_protocol(
    ...
    od_metric_results: dict[str, bool] = statically_verify_component_entrypoint_against_protocol(
        protocol_module="maite.protocols.object_detection",
        protocol_name="Metric",
        package_name="maite",
    )
...
def test_verify_exposed_component_entrypoints():
    ...
    exposed_component_verification_results: dict[str, bool] = statically_verify_exposed_component_entrypoints(
        package_name="maite",
    )
