...
from typing import Any, Dict, Hashable, List, Sequence, Tuple, Union, overload

import numpy as np
import numpy.typing as npt

from maite._internals.protocols import DatumMetadata
...
# DatumMetadataType is an ordinary Python Class with integer-formatted 'id' field
#
# InputBatchType = np.array of shape [N, H, W, C]
# TargetBatchType = np.array of shape [N, Cl]
# DatumMetadataBatchType is an ordinary Python Class with integer-formatted 'id' field
...
class AugmentationImpl:
    ...
    @overload
    def __call__(
        self, __datum: Tuple[InputType, TargetType, DatumMetadataType]
    ) -> Tuple[npt.NDArray, npt.NDArray, DatumMetadata_impl]:
        ...
    ...
    def __call__(
        ...
        _datum_or_datum_batch: (
            Union[
                ...
                Tuple[InputBatchType, TargetBatchType, DatumMetadataBatchType],
            ]
        ),
    ) -> (
        Tuple[npt.NDArray, npt.NDArray, DatumMetadata_impl]
        ...
        if isinstance(
            ...
            assert (
                ...
                and isinstance(_datum_or_datum_batch[2], DatumMetadataType)
            )
...
class Model_impl:
    @overload
    def __call__(
        self, __input: Union[InputType, InputBatchType]
    ) -> Union[TargetType, TargetBatchType]:
        ...
    ...
    def __call__(
        self,
        __input_or_input_batch: Union[InputType, InputBatchType],
    ) -> Union[TargetType, TargetBatchType]:
        ...
...
class Metric_impl:
    ...
    def update(
        self,
        _preds: Union[TargetType, TargetBatchType],
        _targets: Union[TargetType, TargetBatchType],
    ) -> None:
        return None
